...
exports.resheduleConsultation=async (req, res) => {
    try {
        const { id } = req.params;
...
exports.markConsultation= async (req, res) => {
    try {
...
exports.uploadPatientdoc = async (req, res) => {
    try {
...
exports.consultationSummary=async (req, res) => {
    try {
